...
#   OR
#   scp aws-setup.sh ubuntu@YOUR_EC2_IP:/tmp/
...
echo "============================================"
echo "  Flow Kit — AWS EC2 Auto Setup"
echo "============================================"
echo ""
...
echo ""
echo "Services:"
echo "  Backend API:  http://$(curl -s http://169.254.169.254/latest/meta-data/public-ipv4):8100"
echo "  Frontend UI:  http://$(curl -s http://169.254.169.254/latest/meta-data/public-ipv4):3000"
echo "  WebSocket:    ws://$(curl -s http://169.254.169.254/latest/meta-data/public-ipv4):9222"
echo ""
...
echo ""
echo "Next steps:"
echo "  1. Open http://$(curl -s http://169.254.169.254/latest/meta-data/public-ipv4):3000 in browser"
echo "  2. Install the Chrome extension"
echo "  3. Set extension config_ws_url to ws://$(curl -s http://169.254.169.254/latest/meta-data/public-ipv4):9222"
echo "  4. Set extension config_http_callback_url to http://$(curl -s http://169.254.169.254/latest/meta-data/public-ipv4):8100/api/ext/callback"
echo ""
echo "Check services:"
